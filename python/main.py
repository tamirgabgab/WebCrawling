...
def main():
    urls = read_file(path)
    crawlers = set_crawlers(urls, max_links=4, max_urls=40)
    ...
    if print_results:
        print_results([crawlers[0].All_viseted_URLS_2, all_crawls_dict, all_emails, imported_urls,
                       imported_urls_per_domain], with_text=True)
